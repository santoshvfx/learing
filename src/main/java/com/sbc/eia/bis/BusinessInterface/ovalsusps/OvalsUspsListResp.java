// $Id: OvalsUspsListResp.java,v 1.3 2003/03/21 19:24:32 dm2328 Exp $
 ...
 */
public class OvalsUspsListResp extends AddrAltResultResp {
	 ...
	 */
	OvalsUspsListResp(LIMBase utility, RetrieveLocReq request,
	...
	protected void parseAddressTypeImpl() {
		...
		try {
			...
			while (sagentIt.hasNext()) {
                ...
                addressOpt = address.toAddressOpt();
                ...
                if (populateAlt)
                {
                	...
                	catch (org.omg.CORBA.BAD_OPERATION e) { propertyBuilder.setProviderName (null); }
        			catch (java.lang.NullPointerException e) { propertyBuilder.setProviderName (null); }
                	...
                	if ( isAMQValueExist && sagent.getAMQ().substring(0,1).equalsIgnoreCase("2") )
                	{
                    propertyBuilder.setAddressMatchCodeDescription( getAMQDescription( sagent ), true );
                	}
                	...
                	loc.aProviderLocationProperties = new ProviderLocationProperty[]{ propertyBuilder.getProviderLocationProperty() };
