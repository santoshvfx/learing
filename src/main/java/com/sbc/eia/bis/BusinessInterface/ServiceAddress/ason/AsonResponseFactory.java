//$Id: AsonResponseFactory.java,v 1.3 2007/10/07 22:10:23 gg2712 Exp $
...
public class AsonResponseFactory 
{
     ...
     */
    public static Address[] getAsonDescAddr(
            LIMBase utility, 
            ASONSagValidResp sagResp)
        throws 
            InvalidData, 
            AccessDenied, 
            BusinessViolation, 
     ...
     * @throws ObjectNotFound
     */
    public static RetrieveLocResp handleDescAddr(
            LIMBase utility, 
            ASONSagValidResp sagResp, 
            int maxAddr, 
            int maxUnit)
     ...
     * @throws InvalidData
     */
    public static RetrieveLocResp handleLuvFromVicuna(
            LIMBase utility, 
            EventResultPair result, 
			AsonRetrieveLocReq aRequest, 
            int maxAddr,
            int maxUnit, 
            EventResultPair savedResult, 
            boolean sagValidReq)
    	throws 
            SystemFailure, 
            InvalidData
     ...
     * @throws ObjectNotFound
     */
    public static RetrieveLocResp handleSagValidFromVicuna(
            LIMBase utility, 
            EventResultPair result, 
            AsonRetrieveLocReq request, 
            AddressHandlerASON addr, 
            int maxAddr,
            int maxUnit, 
            boolean compoundStNmSfx)
    	throws 
            ServiceException, 
            InvalidData, 
            AccessDenied, 
     ...
     */
    public static void handleSystemFailure(
            String ruleFile, 
            LIMBase utility, 
            String code, 
            String text) 
