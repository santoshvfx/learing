// $Id: OvalsUspsResponseFactory.java,v 1.3 2003/07/03 17:46:37 db4252 Exp $
...
public class OvalsUspsResponseFactory {
	 ...
	 * @throws InvalidData
	 */
	public static RetrieveLocResp handleUspsXMLFromOvals(LIMBase utility, OVALS ovals, RetrieveLocReq request, int maxAddr, int maxUnit)
