// $Id: PremisComboResp.java,v 1.3 2004/04/21 12:53:54 db4252 Exp $
...
import com.sbc.eia.bis.lim.transactions.RetrieveLocation.AlternativeAddressesResp;
 ...
 * @author: David Prager
 */
public class PremisComboResp extends RetrieveLocResp implements AlternativeAddressesResp
{
    ...
    public AlternativeAddress[] toAltAddr()
    {
    	...
    	while (it.hasNext())
    	{
    		...
    		aa.aAddress( ((PremisHit) it.next()).getServiceAddress().getAddress() );
    		allArrays.add(aa);
    	}
    	...
    	return (AlternativeAddress[]) allArrays.subList(0,listSize).toArray(new AlternativeAddress[listSize]);
    }
    /**
