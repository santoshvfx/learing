// $Id: AsonHitResp.java,v 1.30.38.2 2011/10/20 22:32:07 dc860q Exp $
 ...
 */
public class AsonHitResp extends AddrMatchResp
{
     ...
     */
    public AsonHitResp(LIMBase utility, ASONLvngUnitValResp aLuv, AsonRetrieveLocReq aRequest)
     ...
     * @exception SystemFailure
     */
    public AsonHitResp(LIMBase utility, ASONSagValidResp addrResp, AsonRetrieveLocReq aRequest, String sagMsg)
    	throws SystemFailure
    {
    	super(utility);
        request = aRequest;
    ...
    protected void setProviderLocationPropertySeq()
    {
        ...
        propertyBuilder.setCentralOfficeCode(svr.centralOffice);
        propertyBuilder.setE911Exempt(svr.e911Exempt);
        propertyBuilder.setE911NonRecurringCharge(svr.e911Nrg);
        propertyBuilder.setE911Surcharge(svr.e911Sur);
        propertyBuilder.setExchangeCode(svr.exchange);
        propertyBuilder.setSurcharge4Percent(String.valueOf(svr.operSur4Ind));
        propertyBuilder.setSurcharge16Percent(String.valueOf(svr.operSur16Ind));
        propertyBuilder.setTarCode(svr.tar);
        
        if (svr.sagWireCenter != null && (svr.sagWireCenter.trim()).length() > 0)
		{
			propertyBuilder.setSagWireCenter(svr.sagWireCenter);
		}
        ...
        {
            propertyBuilder.setRateZoneBandCode(rateBandZone.toString());
        }
        ...
        {
            propertyBuilder.setLocalProviderServingOfficeCode(svr.primaryLso);
            propertyBuilder.setPrimaryNpaNxx(svr.primaryLso);
        }
        else
        {
           ...
           {
               propertyBuilder.setLocalProviderServingOfficeCode(aNpaNxx);
               propertyBuilder.setPrimaryNpaNxx(aNpaNxx);
            }
        }
    ...
    protected boolean lineIsWorking_facsrc(com.sbc.eia.bis.BusinessInterface.ason.Loop loop)
    {
    ...
    protected void addWorkingTn_facsrc(com.sbc.eia.bis.BusinessInterface.ason.Loop[] loops)
    {
        String workingTN = "";
