//$Id: AsonAddrRangeResp.java,v 1.3 2007/10/07 22:10:23 gg2712 Exp $
 ...
 * @author: Jean Duka
 */
public class AsonAddrRangeResp extends ServiceAddrRangeResp 
{
     ...
     */
    private void addToSagAddrList(
        sagline_st sagLine, 
        sagkey_st sagKey, 
        sagbypassarea_st sagByPassArea, 
        List sagAddrList) 
    {
