// $Id: PremisRetrieveLocReq.java,v 1.5 2007/10/06 01:04:24 gg2712 Exp $
...
public class PremisRetrieveLocReq extends RetrieveLocReq
{
     ...
     */
    public PremisRetrieveLocReq(LIMBase utility,
            					AddressHandler address,
            					String[]  aLocationPropertiesToGet,
            					String aPreviousOwnerName)
    {
        super(utility, address, aLocationPropertiesToGet, aPreviousOwnerName);
        setUnitRequested();
    }
     ...
     */
    public PremisRetrieveLocReq(LIMBase utility, TN service, String[] aLocPropertiesToGet)
    {
    	super(utility, service, aLocPropertiesToGet);
    }
