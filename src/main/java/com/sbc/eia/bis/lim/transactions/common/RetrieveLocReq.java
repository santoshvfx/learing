//$Id: RetrieveLocReq.java,v 1.3 2007/10/07 21:58:55 gg2712 Exp $
...
public class RetrieveLocReq
{
    ...
    protected String previousOwnerName = null;
    ...
    public class LocationPropertiesRequested 
    {
        ...
        /*New properties for ServiceLocation*/
        boolean retrieveSAGAddress                     = false;
        boolean retrieveBuildingType                   = false;
        boolean retrieveLegalEntity                    = false;
        boolean retrieveVideoHubOffice                 = false;
        boolean retrieveSmartmoves                     = false;
        boolean retrieveServingNetworkType             = false;
        boolean retrieveLocationType                   = false;
        boolean retrieveCrossBoundaryState             = false;
        boolean retrieveIndependentCompanyIndicator    = false;
        boolean retrieveAreaTransferCutDate            = false;
        boolean retrieveAreaTransferNumberChangeDate   = false;
        boolean retrieveAreaTransferNpaNxx             = false;
        boolean retrieveAreaTransferWireCenter         = false;
        boolean retrieveWireCenter                     = false;
        boolean retrieveConnectThrough                 = false;
        boolean retrieveExtensions                     = false;
        ...
        public void setDefaultToTrue()
        {
            ...
            /*New properties for ServiceLocation*/
            retrieveSAGAddress                     = true;
            retrieveBuildingType                   = true;
            retrieveLegalEntity                    = true;
            retrieveVideoHubOffice                 = true;
            retrieveSmartmoves                     = true;
            retrieveServingNetworkType             = true;
            retrieveLocationType                   = true;
            retrieveCrossBoundaryState             = true;
            retrieveIndependentCompanyIndicator    = true;
            retrieveAreaTransferCutDate            = true;
            retrieveAreaTransferNumberChangeDate   = true;
            retrieveAreaTransferNpaNxx             = true;
            retrieveAreaTransferWireCenter         = true;
            retrieveWireCenter                     = true;
            retrieveConnectThrough                 = true;
            retrieveExtensions                     = true;
        }
...
//                   retrieveSwitchSuperPopAddress = true;
//               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.ADDRESSMATCHCODE))
                   retrieveAddressMatchCode = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.ADDRESSMATCHCODEDESCRIPTION))
                   retrieveAddressMatchCodeDescription = true;
...
//                   retrieveRateCenterCode = true;
               ...
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.RATEZONE)) 
                   retrieveRateZone = true;
...
//                   retrieveVerticalCoordinate = true;
               ...
               /* New Properties for ServiceLocation*/
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.SAGADDRESS)) 
                   retrieveSAGAddress = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.BUILDINGTYPE)) 
                   retrieveBuildingType = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.LEGALENTITY)) 
                   retrieveLegalEntity = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.VIDEOHUBOFFICE)) 
                   retrieveVideoHubOffice = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.SMARTMOVES)) 
                   retrieveSmartmoves = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.SERVINGNETWORKTYPE)) 
                   retrieveServingNetworkType = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.LOCATIONTYPE)) 
                   retrieveLocationType = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.CROSSBOUNDARYSTATE)) 
                   retrieveCrossBoundaryState = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.INDEPENDENTCOMPANYINDICATOR)) 
                   retrieveIndependentCompanyIndicator = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.AREATRANSFERCUTDATE)) 
                   retrieveAreaTransferCutDate = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.AREATRANSFERNUMBERCHANGEDATE)) 
                   retrieveAreaTransferNumberChangeDate = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.AREATRANSFERNPANXX)) 
                   retrieveAreaTransferNpaNxx = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.AREATRANSFERWIRECENTER)) 
                   retrieveAreaTransferWireCenter = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.WIRECENTER)) 
                   retrieveWireCenter = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.CONNECTTHROUGH)) 
                   retrieveConnectThrough = true;
               
               if (locationPropertyToGet.equalsIgnoreCase(LIMTag.EXTENSIONS)) 
                   retrieveExtensions = true;
            } // end for loop
        }
       ...
       /**
        ...
        /**
         * Returns the retrieveSAGAddress.
         * @return boolean
         */
        public boolean isRetrieveSAGAddress()
        {
            return retrieveSAGAddress;
        }
        
        /**
         * Returns the retrieveBuildingType.
         * @return boolean
         */
        public boolean isRetrieveBuildingType()
        {
            return retrieveBuildingType;
        }
        
        /**
         * Returns the retrieveLegalEntity.
         * @return boolean
         */
        public boolean isRetrieveLegalEntity()
        {
            return retrieveLegalEntity;
        }
        
        /**
         * Returns the retrieveVideoHubOffice.
         * @return boolean
         */
        public boolean isRetrieveVideoHubOffice()
        {
            return retrieveVideoHubOffice;
        }
        
        /**
         * Returns the retrieveSmartmoves.
         * @return boolean
         */
        public boolean isRetrieveSmartmoves()
        {
            return retrieveSmartmoves;
        }
        
        /**
         * Returns the retrieveServingNetworkType.
         * @return boolean
         */
        public boolean isRetrieveServingNetworkType()
        {
            return retrieveServingNetworkType;
        }
        
        /**
         * Returns the retrieveLocationType.
         * @return boolean
         */
        public boolean isRetrieveLocationType()
        {
            return retrieveLocationType;
        }
        
        /**
         * Returns the retrieveCrossBoundaryState.
         * @return boolean
         */
        public boolean isRetrieveCrossBoundaryState()
        {
            return retrieveCrossBoundaryState;
        }
        
        /**
         * Returns the retrieveIndependentCompanyIndicator.
         * @return boolean
         */
        public boolean isRetrieveIndependentCompanyIndicator()
        {
            return retrieveIndependentCompanyIndicator;
        }
        
        /**
         * Returns the retrieveAreaTransferCutDate.
         * @return boolean
         */
        public boolean isRetrieveAreaTransferCutDate()
        {
            return retrieveAreaTransferCutDate;
        }
        
        /**
         * Returns the retrieveAreaTransferNumberChangeDate.
         * @return boolean
         */
        public boolean isRetrieveAreaTransferNumberChangeDate()
        {
            return retrieveAreaTransferNumberChangeDate;
        }
        
        /**
         * Returns the retrieveAreaTransferNpaNxx.
         * @return boolean
         */
        public boolean isRetrieveAreaTransferNpaNxx()
        {
            return retrieveAreaTransferNpaNxx;
        }
        
        /**
         * Returns the retrieveAreaTransferWireCenter.
         * @return boolean
         */
        public boolean isRetrieveAreaTransferWireCenter()
        {
            return retrieveAreaTransferWireCenter;
        }
        
        /**
         * Returns the retrieveWireCenter.
         * @return boolean
         */
        public boolean isRetrieveWireCenter()
        {
            return retrieveWireCenter;
        }
        
        /**
         * Returns the retrieveConnectThrough.
         * @return boolean
         */
        public boolean isRetrieveConnectThrough()
        {
            return retrieveConnectThrough;
        }
        
        /**
         * Returns the retrieveExtensions.
         * @return boolean
         */
        public boolean isRetrieveExtensions()
        {
    ...
    /**
     * Create a RetrieveLocReq object from a retrieveLocationForTelephoneNumber request.
     * @param utility  a LIMBase
     * @param service TN
     * @param aLocPropertiesToGet String[]
     */
                          ...
                          String[] aLocPropertiesToGet)
    {
        ...
        if (aLocPropertiesToGet == null  ||
            aLocPropertiesToGet.length == 0)
        {
            setPropertiesToGetArray(getDefaultLocationPropertiesToGet());
        }
        else
        {
        	setPropertiesToGetArray(aLocPropertiesToGet);
        }
    ...
    /**
     * Create a RetrieveLocReq object from a retrieveLocationForServiceAddress request.
     * @param utility LIMBase
     * @param address AddressHandler
     * @param aLocationPropertiesToGetSeqOpt LocationPropertiesToGetSeqOpt
     * @param aPreviousOwnerName StringOpt
     */
    public RetrieveLocReq(LIMBase utility,
            			  AddressHandler address,
            			  String[] aLocationPropertiesToGetSeq,
    ...
    {   
    	...
    	setAddr(address);
    	setTn(new TN());
    	setPreviousOwnerName(aPreviousOwnerName);
    	
    	if(aLocationPropertiesToGetSeq == null ||
    	   aLocationPropertiesToGetSeq.length == 0)
    	{
    	    setPropertiesToGetArray(getDefaultLocationPropertiesToGet());
    	}
    	else
    	{
    	    setPropertiesToGetArray(aLocationPropertiesToGetSeq);
    	}
        setLocationPropertiesRequested(new LocationPropertiesRequested());
    }
     ...
     * @param aLocPropertiesToGet String[]
     */
    public RetrieveLocReq(LIMBase utility,AddressHandler address, String[] aLocPropertiesToGet )
   {   
   setUtility(utility);
   setBisContext(utility.getCallerContext());
   setAddr(address);
   ...
   setLocationPropertiesRequested(new LocationPropertiesRequested());
	...
	/**
	 * Sets the PreviousOwnerName.
	 * @param aPreviousOwnerName StringOpt
	 */
	public void setPreviousOwnerName(String aPreviousOwnerName) {
		
		try
		{
		    previousOwnerName =  aPreviousOwnerName.trim();
		}
		catch(Exception e)
		{
		    previousOwnerName = "";
     ...
     * @param aLocationPropertyArray String []
     */
    public void setPropertiesToGetArray(String [] aLocationPropertyArray)
    {
        propertiesToGetArray = aLocationPropertyArray;
    }
    ...
    /**
     * Returns the Default Location Properties.
     * @return String[]
     */
    public String[] getDefaultLocationPropertiesToGet()
    {
        String aLocationPropertiesToGet[] = new String[2];
        ...
        return aLocationPropertiesToGet;
    }
