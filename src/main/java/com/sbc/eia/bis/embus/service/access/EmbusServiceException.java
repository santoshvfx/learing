 ...
 *  Description
 */
public class EmbusServiceException extends ServiceException
{
    ...
    /**
     * Constructor for EmbusServiceException.
     * @param i_serviceExceptionMessage
     * @param i_originalException
     */
    public EmbusServiceException(
     ...
     * @param i_serviceExceptionMessage
     */
    public EmbusServiceException(String i_serviceExceptionMessage)
    {
     ...
     * @param i_originalException
     */
    public EmbusServiceException(Exception i_originalException)
    {
        super(i_originalException);
    }
    
    public EmbusServiceException( String code, String description, Properties properties, String body )
    {
        super(body);
        errorCode = code;
