// $Id: NpaPrfxLn_PR_tHelper.java,v 1.1 2002/09/29 04:28:11 dm2328 Exp $
...
public class NpaPrfxLn_PR_tHelper { 
	private static TypeCode myTc = null;
	private NpaPrfxLn_PR_tHelper () {
	}
	public static com.sbc.gwsvcs.service.premisserver.interfaces.NpaPrfxLn_PR_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/premisserver/interfaces/NpaPrfxLn_PR_t:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.premisserver.interfaces.NpaPrfxLn_PR_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.premisserver.interfaces.NpaPrfxLn_PR_t read (org.omg.CORBA.portable.InputStream i) { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[2].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.premisserver.interfaces.LnPR_tHelper.id(), "LnPR_t", members[2].type);
			myTc = ORB.init().create_struct_tc (id(), "NpaPrfxLn_PR_t", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.premisserver.interfaces.NpaPrfxLn_PR_t value) { 
		{
			byte[] _bytes = new byte[4];
