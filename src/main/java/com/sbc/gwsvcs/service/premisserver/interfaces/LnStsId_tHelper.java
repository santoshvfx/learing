// $Id: LnStsId_tHelper.java,v 1.1 2002/09/29 04:28:11 dm2328 Exp $
...
public class LnStsId_tHelper { 
	private static TypeCode myTc = null;
	private LnStsId_tHelper () { }
	public static String extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return a.extract_string (); 
	}
	public static String id() { return "IDL:com.sbc.gwsvcs.service.premisserver.interfaces.LnStsId_t:1.0"; }
