// $Id: Dy_tHelper.java,v 1.1 2002/09/29 04:28:11 dm2328 Exp $
...
public class Dy_tHelper { 
	...
	public static String id() { return "IDL:com.sbc.gwsvcs.service.premisserver.interfaces.Dy_t:1.0"; }
	...
	public static TypeCode type() { 
		if (myTc == null)
		{
			...
			members[0].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.premisserver.interfaces.Dy_tHelper.id(), "Dy_t", members[0].type);
			myTc = members[0].type;
		}
		return myTc; 
	}
