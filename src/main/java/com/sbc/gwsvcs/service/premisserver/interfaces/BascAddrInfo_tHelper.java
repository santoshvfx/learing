// $Id: BascAddrInfo_tHelper.java,v 1.1 2002/09/29 04:28:10 dm2328 Exp $
...
public class BascAddrInfo_tHelper { 
	private static TypeCode myTc = null;
	private BascAddrInfo_tHelper () {
	}
	public static com.sbc.gwsvcs.service.premisserver.interfaces.BascAddrInfo_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/premisserver/interfaces/BascAddrInfo_t:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.premisserver.interfaces.BascAddrInfo_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.premisserver.interfaces.BascAddrInfo_t read (org.omg.CORBA.portable.InputStream i) { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[4].name = "STATE_CD";
			members[4].type = ORB.init().create_array_tc (
				3, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[4].type = ORB.init ().create_alias_tc (com.sbc.gwsvcs.service.premisserver.interfaces.StateCd_tHelper.id(), "StateCd_t", members[4].type);
			myTc = ORB.init().create_struct_tc (id(), "BascAddrInfo_t", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.premisserver.interfaces.BascAddrInfo_t value) { 
