// $Id: PremisValdtAddrReq_tHelper.java,v 1.1 2002/09/29 04:28:13 dm2328 Exp $
...
public class PremisValdtAddrReq_tHelper { 
	private static TypeCode myTc = null;
	private PremisValdtAddrReq_tHelper () {
	}
	public static com.sbc.gwsvcs.service.premisserver.interfaces.PremisValdtAddrReq_t extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/premisserver/interfaces/PremisValdtAddrReq_t:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.premisserver.interfaces.PremisValdtAddrReq_t t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.premisserver.interfaces.PremisValdtAddrReq_t read (org.omg.CORBA.portable.InputStream i) { 
		...
		value.RapReq = com.sbc.gwsvcs.service.premisserver.interfaces.RapReq_tHelper.read (i);
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[1].name = "RapReq";
			members[1].type = com.sbc.gwsvcs.service.premisserver.interfaces.RapReq_tHelper.type();
			...
			myTc = ORB.init().create_struct_tc (id(), "PremisValdtAddrReq_t", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.premisserver.interfaces.PremisValdtAddrReq_t value) { 
		com.sbc.gwsvcs.service.premisserver.interfaces.Header_tHelper.write (o, value.Header);
		com.sbc.gwsvcs.service.premisserver.interfaces.RapReq_tHelper.write (o, value.RapReq);
