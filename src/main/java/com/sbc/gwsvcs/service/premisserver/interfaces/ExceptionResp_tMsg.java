// $Id: ExceptionResp_tMsg.java,v 1.1 2002/09/29 04:28:11 dm2328 Exp $
...
public class ExceptionResp_tMsg implements MMarshalObject { 
	...
	public static com.sbc.gwsvcs.service.premisserver.interfaces.ExceptionResp_t create () { 
		...
		value.OutExcp = new com.sbc.gwsvcs.service.premisserver.interfaces.GWException_t();
		return value; 
	}
	...
	static public ExceptionResp_t decodeExceptionResp_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		...
		value.OutExcp = com.sbc.gwsvcs.service.premisserver.interfaces.GWException_tMsg.decodeGWException_t (ms, "OutExcp");
	...
	static public void encodeExceptionResp_t (MMarshalStrategy ms, ExceptionResp_t value, String tag) throws MMarshalException { 
		...
		com.sbc.gwsvcs.service.premisserver.interfaces.GWException_tMsg.encodeGWException_t (ms, value.OutExcp, "OutExcp");
