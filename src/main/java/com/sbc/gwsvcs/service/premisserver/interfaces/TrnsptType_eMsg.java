// $Id: TrnsptType_eMsg.java,v 1.1 2002/09/29 04:28:15 dm2328 Exp $
...
public class TrnsptType_eMsg implements MMarshalObject { 
	...
	public static com.sbc.gwsvcs.service.premisserver.interfaces.TrnsptType_e create () { 
		return com.sbc.gwsvcs.service.premisserver.interfaces.TrnsptType_e.RPC_TRNSPT; 
	}
	...
	static public TrnsptType_e decodeTrnsptType_e (MMarshalStrategy ms, String tag) throws MMarshalException { 
		...
		try { 
			return com.sbc.gwsvcs.service.premisserver.interfaces.TrnsptType_e.from_int (enumVal); 
		} catch (BAD_PARAM e) { 
