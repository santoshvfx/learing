...
public class EPLUAF_Section_tMsg implements MMarshalObject { 
	public EPLUAF_Section_t value;

	public EPLUAF_Section_tMsg () {
	}
	public EPLUAF_Section_tMsg (EPLUAF_Section_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeEPLUAF_Section_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeEPLUAF_Section_t (ms, tag); 
	}
	static public EPLUAF_Section_t decodeEPLUAF_Section_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		EPLUAF_Section_t value = create();
	...
	static public void encodeEPLUAF_Section_t (MMarshalStrategy ms, EPLUAF_Section_t value, String tag) throws MMarshalException { 
	...
	public static byte [] toOctet (EPLUAF_Section_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeEPLUAF_Section_t (ms, val, "EPLUAF_Section_t");
	...
	public static EPLUAF_Section_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeEPLUAF_Section_t (ms, "EPLUAF_Section_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.EPLUAF_Section_t create () { 
