...
public class Loop_Inq_Req_tMsg implements MMarshalObject { 
	public Loop_Inq_Req_t value;

	public Loop_Inq_Req_tMsg () {
	}
	public Loop_Inq_Req_tMsg (Loop_Inq_Req_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeLoop_Inq_Req_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeLoop_Inq_Req_t (ms, tag); 
	}
	static public Loop_Inq_Req_t decodeLoop_Inq_Req_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		Loop_Inq_Req_t value = create();
	...
	static public void encodeLoop_Inq_Req_t (MMarshalStrategy ms, Loop_Inq_Req_t value, String tag) throws MMarshalException { 
	...
	public TypeCode getType () { 
		return com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Inq_Req_tHelper.type(); 
	}
	public static byte [] toOctet (Loop_Inq_Req_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeLoop_Inq_Req_t (ms, val, "Loop_Inq_Req_t");
	...
	public static Loop_Inq_Req_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeLoop_Inq_Req_t (ms, "Loop_Inq_Req_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Inq_Req_t create () { 
