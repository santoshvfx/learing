...
public class EPCABLE_Section_tMsg implements MMarshalObject { 
	public EPCABLE_Section_t value;

	public EPCABLE_Section_tMsg () {
	}
	public EPCABLE_Section_tMsg (EPCABLE_Section_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeEPCABLE_Section_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeEPCABLE_Section_t (ms, tag); 
	}
	static public EPCABLE_Section_t decodeEPCABLE_Section_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		EPCABLE_Section_t value = create();
	...
	static public void encodeEPCABLE_Section_t (MMarshalStrategy ms, EPCABLE_Section_t value, String tag) throws MMarshalException { 
	...
	public static byte [] toOctet (EPCABLE_Section_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeEPCABLE_Section_t (ms, val, "EPCABLE_Section_t");
	...
	public static EPCABLE_Section_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeEPCABLE_Section_t (ms, "EPCABLE_Section_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.EPCABLE_Section_t create () { 
