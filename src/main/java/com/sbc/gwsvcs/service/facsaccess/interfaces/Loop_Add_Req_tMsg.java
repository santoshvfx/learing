...
public class Loop_Add_Req_tMsg implements MMarshalObject { 
	public Loop_Add_Req_t value;

	public Loop_Add_Req_tMsg () {
	}
	public Loop_Add_Req_tMsg (Loop_Add_Req_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeLoop_Add_Req_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeLoop_Add_Req_t (ms, tag); 
	}
	static public Loop_Add_Req_t decodeLoop_Add_Req_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		Loop_Add_Req_t value = create();
	...
	static public void encodeLoop_Add_Req_t (MMarshalStrategy ms, Loop_Add_Req_t value, String tag) throws MMarshalException { 
	...
	public static byte [] toOctet (Loop_Add_Req_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeLoop_Add_Req_t (ms, val, "Loop_Add_Req_t");
	...
	public static Loop_Add_Req_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeLoop_Add_Req_t (ms, "Loop_Add_Req_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.Loop_Add_Req_t create () { 
