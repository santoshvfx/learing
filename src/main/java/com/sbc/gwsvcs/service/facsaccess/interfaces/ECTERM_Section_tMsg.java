...
public class ECTERM_Section_tMsg implements MMarshalObject { 
	public ECTERM_Section_t value;

	public ECTERM_Section_tMsg () {
	}
	public ECTERM_Section_tMsg (ECTERM_Section_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeECTERM_Section_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeECTERM_Section_t (ms, tag); 
	}
	static public ECTERM_Section_t decodeECTERM_Section_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		ECTERM_Section_t value = create();
		...
		value.ZTEINT = ms.decodeOctetString (13, "ZTEINT");
		...
		value.VER_NO = ms.decodeOctetString (2, "VER_NO");
		...
		value.PEND = ms.decodeOctetString (14, "PEND");
		value.RULES = ms.decodeOctetString (18, "RULES");
		value.QUALFLG = ms.decodeOctetString (16, "QUALFLG");
		{ 
	...
	static public void encodeECTERM_Section_t (MMarshalStrategy ms, ECTERM_Section_t value, String tag) throws MMarshalException { 
		ms.startStruct (tag, true);
		ms.encode (value.PRT, 5, "PRT");
		ms.encode (value.STEP, 8, "STEP");
		ms.encode (value.DREC, 2, "DREC");
		ms.encode (value.TEA, 51, "TEA");
		ms.encode (value.ZTEINT, 13, "ZTEINT");
		...
		ms.encode (value.VER_NO, 2, "VER_NO");
		...
		ms.encode (value.PEND, 14, "PEND");
		ms.encode (value.RULES, 18, "RULES");
		ms.encode (value.QUALFLG, 16, "QUALFLG");
		{ 
	...
	public static byte [] toOctet (ECTERM_Section_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeECTERM_Section_t (ms, val, "ECTERM_Section_t");
	...
	public static ECTERM_Section_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeECTERM_Section_t (ms, "ECTERM_Section_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.ECTERM_Section_t create () { 
		...
		value.PEND = new String ();
		value.RULES = new String ();
		value.QUALFLG = new String ();
		int __seqLength = 0;
		value.INRNG = new com.sbc.gwsvcs.service.facsaccess.interfaces.INRNG_t[__seqLength];
		value.OUTRNG = new com.sbc.gwsvcs.service.facsaccess.interfaces.OUTRNG_t[__seqLength];
		value.ATTRNG = new com.sbc.gwsvcs.service.facsaccess.interfaces.ATTRNG_t[__seqLength];
