...
public class SEG_SO_tMsg implements MMarshalObject { 
	public SEG_SO_t value;

	public SEG_SO_tMsg () {
	}
	public SEG_SO_tMsg (SEG_SO_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeSEG_SO_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeSEG_SO_t (ms, tag); 
	}
	static public SEG_SO_t decodeSEG_SO_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		SEG_SO_t value = create();
		...
		value.FICTMED = ms.decodeOctetString (6, "FICTMED");
		value.FICTEA = ms.decodeOctetString (51, "FICTEA");
		value.FICTYPE = ms.decodeOctetString (6, "FICTYPE");
		{ 
	...
	static public void encodeSEG_SO_t (MMarshalStrategy ms, SEG_SO_t value, String tag) throws MMarshalException { 
		...
		ms.encode (value.FICTMED, 6, "FICTMED");
		ms.encode (value.FICTEA, 51, "FICTEA");
		ms.encode (value.FICTYPE, 6, "FICTYPE");
		{ 
	...
	public static byte [] toOctet (SEG_SO_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeSEG_SO_t (ms, val, "SEG_SO_t");
	...
	public static SEG_SO_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeSEG_SO_t (ms, "SEG_SO_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.SEG_SO_t create () { 
		...
		value.FICTMED = new String ();
		value.FICTEA = new String ();
		value.FICTYPE = new String ();
		int __seqLength = 0;
		value.ASGBP = new com.sbc.gwsvcs.service.facsaccess.interfaces.ASGBP_t[__seqLength];
		return value; 
	} 
