...
public class ADDR_LOOP_tMsg implements MMarshalObject { 
	public ADDR_LOOP_t value;

	public ADDR_LOOP_tMsg () {
	}
	public ADDR_LOOP_tMsg (ADDR_LOOP_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeADDR_LOOP_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeADDR_LOOP_t (ms, tag); 
	}
	static public ADDR_LOOP_t decodeADDR_LOOP_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		ADDR_LOOP_t value = create();
		...
		{ 
			ms.startSequence ("PNDORD", false);
			int __seqLength = ms.decodeULong ("_sequenceLength", true);
			ms.startArray ("PNDORD", false);
			{ 
				value.PNDORD = new com.sbc.gwsvcs.service.facsaccess.interfaces.PNDORD_t[__seqLength];
				for (int __i0 = 0; __i0 < __seqLength; __i0++) { 
					value.PNDORD[__i0] = com.sbc.gwsvcs.service.facsaccess.interfaces.PNDORD_tMsg.decodePNDORD_t (ms, "PNDORD");
				} 
			}
			ms.endArray ("PNDORD", false);
			ms.endSequence ("PNDORD", false);
		}
		ms.endStruct (tag, false);
		return value; 
	}
	static public void encodeADDR_LOOP_t (MMarshalStrategy ms, ADDR_LOOP_t value, String tag) throws MMarshalException { 
		...
		{ 
			ms.startSequence ("PNDORD", true);
			ms.encode (value.PNDORD.length, "_sequenceLength", true);
			ms.startArray ("PNDORD", true);
			{ 
				for (int __i0 = 0; __i0 < value.PNDORD.length; __i0++) { 
					com.sbc.gwsvcs.service.facsaccess.interfaces.PNDORD_tMsg.encodePNDORD_t (ms, value.PNDORD[__i0], "PNDORD");
				} 
			}
			ms.endArray ("PNDORD", true);
			ms.endSequence ("PNDORD", true);
		}
	...
	public static byte [] toOctet (ADDR_LOOP_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeADDR_LOOP_t (ms, val, "ADDR_LOOP_t");
	...
	public static ADDR_LOOP_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeADDR_LOOP_t (ms, "ADDR_LOOP_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.ADDR_LOOP_t create () { 
