...
public class Cable_Inq_Req_tMsg implements MMarshalObject { 
	public Cable_Inq_Req_t value;

	public Cable_Inq_Req_tMsg () {
	}
	public Cable_Inq_Req_tMsg (Cable_Inq_Req_t initial) { 
		value = initial; 
	}
	public void encode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		encodeCable_Inq_Req_t (ms, value, tag); 
	}
	public void decode (MMarshalStrategy ms, String tag) throws MMarshalException { 
		value = decodeCable_Inq_Req_t (ms, tag); 
	}
	static public Cable_Inq_Req_t decodeCable_Inq_Req_t (MMarshalStrategy ms, String tag) throws MMarshalException { 
		Cable_Inq_Req_t value = create();
	...
	static public void encodeCable_Inq_Req_t (MMarshalStrategy ms, Cable_Inq_Req_t value, String tag) throws MMarshalException { 
	...
	public static byte [] toOctet (Cable_Inq_Req_t val) throws MMarshalException { 
		try {
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(), true);
			ms.encode (false, null);
			encodeCable_Inq_Req_t (ms, val, "Cable_Inq_Req_t");
	...
	public static Cable_Inq_Req_t fromOctet (byte [] val) throws MMarshalException { 
		try { 
			com.sbc.vicunalite.api.marshal.MCDRStrategy ms = 
				new com.sbc.vicunalite.api.marshal.MCDRStrategy(); 
			ms.init (new MBuffer(val), false);
			ms.setRemote (ms.decodeBoolean (null));
			return decodeCable_Inq_Req_t (ms, "Cable_Inq_Req_t"); 
		} catch (MBufferException e) { 
			throw new MMarshalException ("Buffer error", e); 
		} 
	}
	public static com.sbc.gwsvcs.service.facsaccess.interfaces.Cable_Inq_Req_t create () { 
