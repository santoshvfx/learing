// $Id: lufrecordkeys_stHelper.java,v 1.1 2002/09/29 03:53:00 dm2328 Exp $
...
public class lufrecordkeys_stHelper { 
	private static TypeCode myTc = null;
	private lufrecordkeys_stHelper () {
	}
	public static com.sbc.gwsvcs.service.asonservice.interfaces.lufrecordkeys_st extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
		return read(a.create_input_stream()); 
	}
	public static String id() { return "IDL:com/sbc/gwsvcs/service/asonservice/interfaces/lufrecordkeys_st:1.0"; }
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.asonservice.interfaces.lufrecordkeys_st t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}
	public static com.sbc.gwsvcs.service.asonservice.interfaces.lufrecordkeys_st read (org.omg.CORBA.portable.InputStream i) { 
		...
		}
		{
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.locValue1 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.locValue2 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.locValue3 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.locValue4 = new String (_bytes, 0, _j);
		}
		{
			byte[] _bytes = new byte[11];
			i.read_octet_array (_bytes, 0, 11);
			...
			for (_j = 0; _j < 11; _j++)
				if (_bytes[_j] == 0)
					break;
			value.locValue5 = new String (_bytes, 0, _j);
		}
		return value; 
	}
	synchronized public static TypeCode type() { 
		if (myTc == null) { 
			...
			members[10].name = "locValue2";
			members[10].type = ORB.init().create_array_tc (
				11, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[11] = new StructMember();
			members[11].name = "locValue3";
			members[11].type = ORB.init().create_array_tc (
				11, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[12] = new StructMember();
			members[12].name = "locValue4";
			members[12].type = ORB.init().create_array_tc (
				11, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			members[13] = new StructMember();
			members[13].name = "locValue5";
			members[13].type = ORB.init().create_array_tc (
				11, ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet));
			myTc = ORB.init().create_struct_tc (id(), "lufrecordkeys_st", members); 
		}
		return myTc; 
	}
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.asonservice.interfaces.lufrecordkeys_st value) { 
		{
			byte[] _bytes = new byte[3];
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.locValue1.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.locValue2.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.locValue3.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.locValue4.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
		...
		{
			byte[] _bytes = new byte[11];
			byte[] _bytes_src = value.locValue5.getBytes();
			int _j;
			for (_j = 0; _j < 11 - 1; _j++)
				_bytes[_j] = _bytes_src[_j];
			_bytes[_j] = 0;
