...
public class HostLookup_RHelper { 
	private static TypeCode myTc = null;
	private static boolean __active = false;

	private HostLookup_RHelper () {
	}
	public static com.sbc.gwsvcs.service.hostlookup.interfaces.HostLookup_R read (org.omg.CORBA.portable.InputStream i) { 
	...
	public static void write (org.omg.CORBA.portable.OutputStream o, com.sbc.gwsvcs.service.hostlookup.interfaces.HostLookup_R value) { 
		{
			byte[] _bytes = new byte[7];
	...
	public static void insert (org.omg.CORBA.Any a, com.sbc.gwsvcs.service.hostlookup.interfaces.HostLookup_R t) { 
		org.omg.CORBA.portable.OutputStream o = a.create_output_stream();
		write (o, t);
		a.read_value (o.create_input_stream(), type()); 
	}

	public static com.sbc.gwsvcs.service.hostlookup.interfaces.HostLookup_R extract (org.omg.CORBA.Any a) throws BAD_OPERATION { 
	...
	synchronized public static TypeCode type() { 
		if (myTc == null) {
			...
			synchronized(org.omg.CORBA.TypeCode.class) {
				...
				members[21].name = "OrigEvent";
				members[21].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_long);
				members[22] = new StructMember();
				members[22].name = "ErrorMsg";
				members[22].type = ORB.init().get_primitive_tc (org.omg.CORBA.TCKind.tk_octet);
				members[22].type = ORB.init().create_array_tc (100, members[22].type);
				myTc = ORB.init().create_struct_tc (id(), "HostLookup_R", members);
				__active = false;
			}
		}
		return myTc;
	...
	public static String id() { return "IDL:com/sbc/gwsvcs/service/hostlookup/interfaces/HostLookup_R:1.0"; } 
}
