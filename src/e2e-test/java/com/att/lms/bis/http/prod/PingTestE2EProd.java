...
public class PingTestE2EProd extends AbstractControllerE2E {
    ...
    public void shouldReturnPingReturn(User user, int httpStatus) throws Exception {
        ...
        enc.decodePassword("srv$california", EncryptionIO.loadConvert("GEG\\u0012Z3\\\\\\u0002T 4,-"));
