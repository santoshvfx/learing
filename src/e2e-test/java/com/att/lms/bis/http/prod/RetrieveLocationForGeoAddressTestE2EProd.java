...
public class RetrieveLocationForGeoAddressTestE2EProd extends AbstractControllerE2E {
...
//        String EXPECTED_RESPONSE = "[{\"aContext\":{\"aProperties\":[{\"aTag\":\"Application\",\"aValue\":\"LIM_BIS\"},{\"aTag\":\"CustomerName\",\"aValue\":\"LIM_BIS\"}]},\"aExceptionData\":{\"aCode\":\"LIM-NotImplemented-00080\",\"aDescription\":\"retrieveLocationForGeoAddress is not implemented.\",\"aOrigination\":{\"___theValue\":\"LIM\",\"__discriminator\":true,\"__uninitialized\":false},\"aSeverity\":{\"___theValue\":{\"__value\":1},\"__discriminator\":true,\"__uninitialized\":false}}}]";
        ...
        RetrieveLocationForGeoAddressRequestDto request = RetrieveLocationForGeoAddressRequestDto.builder()
        ...
        String responseBody = given(documentationSpec)
                ...
                .filter(document("retrieveLocationForGeoAddress-prod",
                ...
                .post(StringUtils.join(DEFAULT_SPRING_BOOT_BASE_URI,
                        BisApi.LIM_BASE_URL,
                        "/",
                        LimController.RETRIEVE_LOCATION_FOR_GEO_ADDRESS_PATH_NAME))
                .then()
                .statusCode(500)
                .extract()
                .response()
